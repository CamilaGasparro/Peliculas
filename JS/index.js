...
const API_KEY= "d7f705066ef239a7b2614b1462d45cc9";

//genera un evento donde obtiene todas las peliculas
document.addEventListener("DOMContentLoaded", () => { //cuando la pagina haya cargado
    renderNewsMovies();
    renderListMovies('popular', 'now-playing__list');
    renderListMovies('top_rated', 'top-rated-playing__list');
})

// metodo que va a devolver todas las peliculas
...
const renderNewsMovies = async () => {
    ...
    let html = '';
    //hay que recorrer pelixpeli y formar bloques
    ...
    <a class="carousel-control-next"  href="#carousel-news-movies" role="button" data-slide="next">
     ...
     `;
    //que meta el contenido dentro de js
